...
```{r}
ggplot(hf, aes(reorder(`2digit name`, rmmean), y=dif_wage, color=`1digit name`)) + geom_point(size = 5)+  
  theme_light() +
 ...
 labs(title="Change in weighted mean wage (1983-2001), sorted by occupational routine manual skill", x="Occupation, sorted by 1980 weighted routinue manual skill (asc)", y="Change in weighted mean wage (1983-2001)")
